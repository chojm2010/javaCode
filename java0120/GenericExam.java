...
class GenericTest<T>{
	// T는 객체타입만 가능해서 Integer 클래스를 사용해야 정수형을 읽을수 있음.
	// T는 인스턴스 변수로 간주된다
	// -> static에는 사용 불가.
	// 제네릭 배열생성은 불가능
...
public class GenericExam {
	...
	public static void main(String[] args) {
		...
		// 데이터가 구성될수 있는 클래스를 설계시 제네릭을 사용해서 타입문제를
		// 차단할수 있다.
		// Color col = new Color(Color.red);
		
		// ArrayList의 경우 클래스로 Object 타입의 데이터를 저장할수있다.
		// Object 클래스는 최상위클래스(모든 자바 클래스의 슈퍼클래스)
		//  -> 실레조 모든 자바 클래스가 요소로 들어갈수 있다.
		// ArrayList가 모든 타입들을 받을수 있지만. 저장된 요소를 꺼낼때
		...
		// 제네릭의 장점.
		// 제네릭 클래스 타입의 객체 생성시 개발자가 원하는 타입을 지정할수 있음.
		// 타입의 안정성이 증대
